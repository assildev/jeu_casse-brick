...
var frame;
exports.frame = frame;
},{}],"appNew.js":[function(require,module,exports) {
"use strict";
 ...
 */
// ball start coords
var ballX = _canvas.canvas.width / 2 + 50;
var ballY = 50; // ball speed

var newBallX = -0;
var newBallY = 3; // board start coords

var boardX = (_canvas.canvas.width - 75) / 2;
var boardY = _canvas.canvas.height - 20;
/**
 * Draw
 */
// board
...
function board() {
  ...
  _canvas.ctx.rect(boardX, boardY, 75, 10);
...
function bricks() {
  for (var _i = 0; _i < 8; _i++) {
    for (var _j = 0; _j < 4; _j++) {
      window.brickX = _i * (100 + 20) + 490;
      window.brickY = _j * (100 + 20) + 100;
      bricksGeo[_i][_j].x = brickX;
      bricksGeo[_i][_j].y = brickY;

      _canvas.ctx.beginPath();

      _canvas.ctx.rect(brickX, brickY, 100, 40);
...
function collisions() {
  for (var _i2 = 0; _i2 < 8; _i2++) {
    for (var _j2 = 0; _j2 < 4; _j2++) {
      var b = bricksGeo[_i2][_j2]; // Collisions ici, mais j'y arrive pas 
      // if(ballY + newBallY + 5 <= b.y + 40 && ballX + newBallX + 5 > b.x && ballX + newBallX + 5 < b.x + 100 ){
      //     newBallY = -newBallY 
      // }
      // if(ballY + newBallY + 5 >= b.y - 2 && ballX + newBallX + 5 > b.x && ballX + newBallX + 5 < b.x + 100 ){
      //     newBallY = -newBallY
      // } 
      // if(ballY + newBallY >= brickY + (40/2)){
      //     newBallY = -newBallY
      // }
      // if(ballX + newBallX < brickX){
      //     newBallX = -newBallX
      // }
      // if(ballX + newBallX > brickX){
      //     newBallX = -newBallX
...
function draw() {
  ...
  if (ballX + newBallX + 5 > _canvas.canvas.width) {
    newBallX = -newBallX;
  }
  ...
  if (ballX + newBallX - 5 < 0) {
    newBallX = -newBallX;
  }

  if (ballY + newBallY + 5 > boardY && ballX + newBallX > boardX && ballX + newBallX < boardX + 75) {
    newBallY = -newBallY;
  }
  /**
   * tentative de controle direction avec le clavier
   */
  ...
  /**
   * detection pinch + direction ( a mettre dans le draw)
   */


  console.log(_function.frame.hands[0]); //console.log(frame.hands[0].pinchStrength)
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","appNew.js"], null)
//# sourceMappingURL=/appNew.4fa4ff93.js.map